...
published: true
published_at: "2026-01-12 18:00"
price: 980
---

# 2026/01/26 更新: DGR 1.45x達成

本記事の技術を実装した結果、**DGRを1.45x上回る4169FPS**を達成しました。

### 最終ベンチマーク (N=100K, 800x600)

| モード | FPS | DGR比 |
|--------|-----|-------|
| **Hash-SORTED** | **4,169** | **1.45x** |
| Hash-WSR | 3,800+ | 1.32x |
| DGR (参考) | 2,870 | 1.0x |
...
**結果: DGR比1.45x高速、100K Gaussians @ 800x600 = 4169 FPS**
