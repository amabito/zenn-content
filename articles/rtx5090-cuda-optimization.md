---
title: "RTX 5090 (Blackwell) でCUDA最適化する際に知っておくべきこと"
emoji: "⚡"
type: "tech"
...
# RTX 5090を買った。で、どう活かす？

RTX 5090（Blackwell世代）を手に入れた。32GB VRAM、96MB L2キャッシュ、sm_120。

スペックは素晴らしい。**でも、古いコードをそのまま動かしても速くならない。**

この記事では、Blackwell世代のGPUを最大限活用するための最適化ポイントを解説する。
