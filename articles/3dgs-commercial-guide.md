---
title: "3DGS商用化ガイド：ライセンス問題から自作ラスタライザまで"
emoji: "💼"
type: "tech"
topics: ["3dgs", "ライセンス", "オープンソース", "商用利用"]
published: true
---

# 3DGSを商用利用したい。でもライセンスが...

3D Gaussian Splatting（3DGS）は素晴らしい技術だ。写真から高品質な3Dモデルを生成できる。

**しかし、商用利用しようとすると壁にぶつかる。**

この記事では、3DGS商用化の道筋を解説する。
